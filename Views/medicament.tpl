                    ...
                    <div class="bg-white tm-block h-100">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped tm-table-striped-even mt-3">
                                ...
                                <tbody>
                                    {if isset($medicaments) && $medicaments}
                                        {foreach from=$medicaments item=medicament}
                                            <tr>
                                                ...
                                                <td>
                                                    <a data-targget="{$medicament->ID_medicament}" class="delete fas fa-trash-alt tm-trash-icon"></a>
                                                </td>
                                                <td>
                                                    <a class="fas fa-pencil-alt tm-trash-icon"
                                                        href='\medicament/modifier/{$medicament->ID_medicament}'></a>
                                                </td>
                                            </tr>
                                        {/foreach}
                                    {else}
